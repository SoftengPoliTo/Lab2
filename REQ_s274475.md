...
|  NFR4     | Reliability | The application provides the correct location to the gas stations   | All FR |
|  NFR5     | Reliability | The data about fuel prices and the nearest gas station should be reliable    | All FR |
...
|  NFR8     | Efficiency | The application should has user friendly interface to encourage user to work with it easily     | All FR |
