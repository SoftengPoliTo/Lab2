...
| ------------- |:-------------:| 
|  Precondition     | Pay by user the fuel price, user login in the app |  
|  Post condition     | Have credit for paying online, or pay be credit card, or pay by available scores |
|  Nominal Scenario     |Price recorded in the fuel price list in DB by app|
|  Variants     | User has not enough money give a warning |
