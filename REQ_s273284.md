...
| ------------- |:-------------:| 
|  Precondition     |Calculate the near Gas stations, Internet connection, availability of google map service|  
|  Post condition     | Calculate the distance to the selected Gas station , Rout the path |
