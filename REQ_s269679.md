...
|  Post condition     | The modification is put in a waitinglist waiting to be approved by a moderator|
...
|  Post condition     | The user is autneticated                              |
|  Nominal Scenario   | The user type username and password and confirm them  |
...
|  2     | The application tye to localize the user|  
...
| Step#        |  Step description   |
|  1     | End user open the application |
|  2     | The application try to localize the user|  
