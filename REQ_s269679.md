...
|  2     | The map with the list of the closest gas station is shown |
...
| Scenario ID: SC3        | Corresponds to UC1 + UC2  |
| ------------- |:-------------| 
| Description | An end user open the application and the map with the gas station is shown|
| Precondition |  Localization is enable and GPS is available|
| Postcondition | The map with the list of gas station is shown  |
| Step#        |  Step description   |
|  1     | End user open the application |
|  2     | The application tries to localize the user|  
|  3     | The map with the list of the closest gas station is shown |

## Scenario 4

| Scenario ID: SC4        | Corresponds to UC1 + UC2  |
| ------------- |:-------------| 
| Description | An end user open the application and the map with the gas station is shown|
| Precondition |  |
