...
|  4 	 | \[the list of gas stations is filtered by kind of fuel]|
|  5	 | through the Maps system, the nearest ones are retrived (the ones that are up to 5 km distant)|
|  6	 | through the Maps system, those are visualized in a Map|
...
|  2     | \[ the user insert a type of fuel] |
|  3     |  the list of gas stations is filtered by city's province|
|  4 	 | \[the list of gas stations is filtered by kind of fuel]|
|  5	 | a default address is added, the one which corresponds to the city center, retrieved from the Maps system|
