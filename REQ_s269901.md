...
|  FR4     | Application will contact a local server to get the info with respect to the stations, prices and availability of the near gas stations |
...
|  NFR5     | Globalization | number of languages available in app ||
