...
|  Nominal Scenario     |Contributor C insert the new informations and they are updated in EzGas|
...
|Precondition | Contributor discovered an updated information|
|Postcondition | The information is updated |
| Step#        | Step description  |
|  1     | Contributor notices an outdated information |  
|  2     | Contributor logs in |
|  3     | Contributor updates informations on EzGas   |
...
| Step#        | Step description  |
|  1     | Sponsor send an E-Mail with his offer |  
|  2     | EzGas personnell decide to accept or reject the offer |
