...
Unfortunately he does not come from an wealthy family and for this reason it is necessary that he saves money as much as  he can in order to be able to realize your inspirations.
...
|  Nominal Scenario| User U update/add Gs' price|
...
| Scenario ID: SC1        | Corresponds to UC3/UC4  |
| ------------- |:-------------|
