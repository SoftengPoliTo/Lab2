...
| ---------------- |:--------------------------------------------------------------------------------------------------------------------:|
| Users|  Uses the application to locate gas station with their prices|
| Gas stations| Use the application to collect prices of fuels|

# Context Diagram and interfaces

## Context Diagram

![](https://i.imgur.com/7SvQYb3.jpg)
...
| ------------------- |:-----------------:| -------------------:|
| User, Administrator |        GUI        |    Screen, keyboard |
...
Charlie has found a new gas station with incredible prices and wants to share his discovery with everyone. Therefore, he opens the EZGas application and asks for create a new gas station location on the map, with its prices. Charlie compiles all the form and sends the application to the administrator of the app. Now Charlie feel good because he have done something useful for the community. 
...
|  NFR3     | Portability | The application runs on Windows, Android and IOs| All FR |
|  NFR4     | Portability | The application (functions and data) should be portable from a PC to another PC in less than 1 minute | All FR |
...
| Actors Involved        | User, Administrator, Database |
| ------------- |:-------------:| 
...
|Postcondition |   |
| Step#        | Step description  |
|  1     | User click on "Add new gas station information" and fill the form|  
