...
Administrator wants to assure data inserted by customers is correct.
...
|  NFR2     | Performance | All functions should complete in < 0.5 sec  | FR1, FR2 |
|  NFR2     | Performance | All functions should complete in < 3 sec  | FR3, FR4, FR5 |
|  NFR3     | Portability | The application runs on web browsers and Android/iOS smartphones  | All FR |
|  NFR4     | Privacy | Data should be uploaded anonymously | FR1 |
...
# System Design
Not really meaningful in this case. Only one personal computer and smartphone is needed.
